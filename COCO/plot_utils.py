...
def plot_heat_maps_from_annotations(img, keypoints, idx_to_keypoint_type=idx_to_keypoint_type, keypoint_type_to_idx=keypoint_type_to_idx, n_items=17, figsize=(16,12), sigma=7):
    fig, axes = plt.subplots(5, 4, figsize=figsize)
    ...
    for i,ax in enumerate(axes.flat):
        ...
        if(i<17):
            ...
            mask,_ = model_utils.calculate_heatmap(img, joint_type, keypoints, keypoint_type_to_idx, sigma)
            ax.imshow(img)
